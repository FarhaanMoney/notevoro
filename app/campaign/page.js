...
export default function CampaignPage() {
  ...
  if (!data) return <div className="min-h-screen bg-gradient-to-br from-black via-purple-900/60 to-black flex items-center justify-center"><Loader2 className="h-6 w-6 animate-spin text-purple-400" /></div>;

  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-900/60 to-black text-zinc-100 p-4 md:p-6">
