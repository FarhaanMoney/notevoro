...
function hasTrialBeenUsed(user) {
  if (!user) return false;
  if (typeof user.trialUsed === 'boolean') return user.trialUsed;
  return Boolean(user.trial_start || user.trialStart);
}
...
export function startProTrial(userId) {
  ...
  if (typeof user.trialUsed !== 'undefined') {
...
export function hasPhoneUsedTrial(phoneNumber) {
  ...
  return hasTrialBeenUsed(user) === true;
}
