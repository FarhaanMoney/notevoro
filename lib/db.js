...
if (!SUPABASE_URL || !SUPABASE_SERVICE_ROLE_KEY) {
  console.warn('SUPABASE_URL (or NEXT_PUBLIC_SUPABASE_URL) / SUPABASE_SERVICE_ROLE_KEY is not set');
}
...
function applyProjection(rows, projection = {}) {
  ...
  // Keep compatibility with include/exclude projection behavior used in this app.
